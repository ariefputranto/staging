...
$config['site_title']                 = "Point to Point System";  // Site Title, example.com

$config['admin_email']                = "digitalvidhya@gmail.com"; // Admin Email, admin@example.com

$config['default_group']              = 'client';            // Default group, use name

$config['admin_group']                = 'admin';             // Default administrators group, use name

$config['executive_group']            = 'executive';             // Default executives group, use name

$config['b2buser_group']              = 'b2buser';             // Default b2busers group, use name

$config['supplier_group']             = 'supplier';             // Default suppliers group, use name

$config['driver_group']           	  = 'driver';             // Default drivers group, use name
...
/*
 ...
 | Share Bill Email Template

 | -------------------------------------------------------------------------

 | Default: share.bill.tpl.php

 */

$config['share_bill'] = 'share.bill.tpl.php';
