      ...
      <div class="admin-body">
		  <div class="inner-elements">
			...
			<?php echo $this->session->flashdata('message');?>
				<?php echo form_open_multipart('driver/profile', 'id="admin_profile_form" class=""');?>
				<div class="form-group">
				  <label><?php if(isset($this->phrases["name"])) echo $this->phrases["name"]; else echo "Name";?></label>
				  <input type="text" name="username" id="username" value="<?php echo set_value('username', (isset($admin_details->username)) ? $admin_details->username : '');?>"/>
				  <?php echo form_error('username');?>
				</div>

				<div class="form-group">
				  <label><?php if(isset($this->phrases["email"])) echo $this->phrases["email"]; else echo "Email";?></label>
				  <input readonly type="text" name="email" id="email" value="<?php echo set_value('email', (isset($admin_details->email)) ? $admin_details->email : '');?>"/>
				...
				<div class="form-group">
                 <label><?php if(isset($this->phrases["photo"])) echo $this->phrases["photo"]; else echo "Photo";?></label>
                  <input name="userfile" type="file" id="image" title="<?php if(isset($this->phrases["driver photo"])) echo $this->phrases["driver photo"]; else echo "Driver Photo";?>"  onchange="readURL(this)" >
                  ...
                  <?php 
                     ...
                     if(isset($admin_details->photo) && file_exists('uploads/driver_profile_pic/'.$admin_details->photo)) {
						$src = base_url()."uploads/driver_profile_pic/".$admin_details->photo;
                     	$style="";
                     }
                     ?>
