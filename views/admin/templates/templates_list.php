  ...
  <div class="inner-elements">
		...
		<a onclick="window.location.href = '<?php echo base_url().'admin/templates/create';?>';" class="btn btn-success" title="Create New"><?php if(!empty($this->phrases["create new"])) echo $this->phrases["create new"]; else echo "Create New";?> <i class="fa fa-plus"></i></a>
                    ...
                    <tr>
                      ...
                      <tbody>
						...
						<tr>
                          ...
                          <td>
              					<a onclick="window.location.href = '<?php echo base_url().'admin/templates/edit/'.$row->template_id;?>';" class="btn btn-success act-btn" title="<?php if(!empty($this->phrases["edit"])) echo $this->phrases["edit"]; else echo "Edit";?>"><i class="fa fa-edit"></i> </a>
...
/****** Delete Message ******/
   function deleteMessage(x){
	...
	var str = "<?php echo base_url();?>admin/templates/delete/"+x;
