      ...
      <div class="admin-body">
		  <div class="inner-elements">
			...
			<?php
				...
				echo form_open('managedriver/create_account', $attributes);
				?>
		  <div class="col-md-6">
			...
			/* Create Account form validation rules */
              $("#register_form").validate({
				...
				messages: {
					...
					password_confirm: {
							  required: "<?php if(!empty($this->phrases["please enter confirm password"])) echo $this->phrases["please enter confirm password"]; else echo "Please enter confirm Password";?>."
						},
					group: {
