      ...
      <div class="admin-body">
		  <div class="inner-elements">
			...
			<?php echo $this->session->flashdata('message');?>
				<?php echo form_open_multipart('admin/profile', 'id="admin_profile_form" class=""');?>
				...
				<div class="form-group">
				  <label><?php if(isset($this->phrases["last name"])) echo $this->phrases["last name"]; else echo "Last Name";?>&nbsp;<font color="red">*</font></label>
				...
				<div class="form-group">
				  ...
				  <input type="text" name="email" id="email" value="<?php echo set_value('email', (isset($admin_details->email)) ? $admin_details->email : '');?>"/>
