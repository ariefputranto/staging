  ...
  <div class="inner-elements">
		...
		<a onclick="window.location.href = '<?php echo base_url().'settings/add_edit_page';?>';" class="btn btn-success" title="Add New"><?php if(isset($this->phrases["add new"])) echo $this->phrases["add new"]; else echo "Add New";?> <i class="fa fa-plus"></i></a>
		...
		<table id="example" class="cell-border example" cellspacing="0" width="100%">
               ...
               <tbody>
                  ...
                  <tr>
					 ...
					 <td><?php echo date('d M,Y', strtotime($page->page_created)); ?></td>
					 <td><?php echo $page->page_status; ?></td>
                     <td>                        
                        <?php 

							$edit_txt = (isset($this->phrases["edit page"])) ? $this->phrases["edit page"] : "Edit Page";

							echo anchor('settings/add_edit_page/'.$page->page_id,'<i class="fa fa-edit"> '.$edit_txt.'</i>','class="btn btn-info act-btn"'); ?> &nbsp;

                        <a class="btn btn-danger act-btn" data-toggle="modal" data-target="#delRecModal" onclick="deleteMessage(<?php echo $page->page_id;?>)"><i class="fa fa-trash"></i></a>  	
                     </td>
                  </tr>
                  <?php } } ?>
...
/****** Delete Message ******/
   function deleteMessage(x){
	...
	var str = "<?php echo base_url();?>settings/pages/delete/"+x;
