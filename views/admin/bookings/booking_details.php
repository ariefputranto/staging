...
<div class="col-md-6">
<ul class="list-group">
<li class="list-group-item"><strong><?php if(isset($this->phrases["cost of journey (incl. all)"])) echo $this->phrases["cost of journey (incl. all)"]; else echo "Cost of Journey (Incl. all)";?> </strong>
<?php echo $site_settings->currency_symbol.' ';
//echo $row->cost_of_journey;
$cost_of_journey = ($row->basic_fare + $row->service_charge + $row->insurance_amount) - $row->discount_amount;
$cost_of_journey = ($cost_of_journey < 0) ? 0 : $cost_of_journey;
$cost_of_journey = number_format($cost_of_journey, 2);
echo $cost_of_journey;
?></li>
...
<?php if($row->insurance_amount != '0.00' && $row->insurance_amount != '') { ?>
<li class="list-group-item"><strong><?php if(isset($this->phrases["insurance"])) echo $this->phrases["insurance"]; else echo "Insurance";?> </strong><?php echo $site_settings->currency_symbol.$row->insurance_amount;?></li>
<?php } ?>
...
<li class="list-group-item"><strong><?php if(isset($this->phrases["booking status"])) echo $this->phrases["booking status"]; else echo "Booking Status";?> </strong>
<?php 
if($row->payment_type == 'finpay')
{
...
<?php if($row->payment_type == 'finpay' && $row->booking_status == 'Cancelled') { ?>
<li class="list-group-item"><strong><?php if(isset($this->phrases["remarks"])) echo $this->phrases["remarks"]; else echo "Remarks";?> </strong><?php echo $row->comments;?></li>
<?php } ?>
...
<li class="list-group-item"><strong><?php if(isset($this->phrases["type"])) echo $this->phrases["type"]; else echo "Type";?> </strong><?php echo ucfirst($passenger->passenger_type);?></li>
...
<li class="list-group-item"><strong><?php if(isset($this->phrases["seat no"])) echo $this->phrases["seat no"]; else echo "Seat No.";?> </strong><?php echo $passenger->seat_no;?></li>
...
<a onclick="window.location.href = '<?php echo base_url().'admin/viewBookings/todayz';?>';" class="btn btn-info" title="Back"><i class="fa fa-arrow-left"></i> <?php if(isset($this->phrases["back"])) echo $this->phrases["back"]; else echo "Back";?></a>

<?php if(($row->booking_status == "Pending" || $row->booking_status == "Cancelled") && date('Y-m-d') <= $row->pick_date) { ?>
...
<?php } } else { ?>
	...
	<a onclick="window.location.href = '<?php echo base_url().'admin/viewBookings';?>';" class="btn btn-success" title="Back"><i class="fa fa-arrow-left"></i> <?php if(isset($this->phrases["back"])) echo $this->phrases["back"]; else echo "Back";?></a>
