  ...
  <div class="inner-elements">
		...
		<a onclick="window.location.href = '<?php echo base_url().'admin/smstemplates/create';?>';" class="btn btn-success" title="Create New"><?php if(!empty($this->phrases["create new"])) echo $this->phrases["create new"]; else echo "Create New";?> <i class="fa fa-plus"></i></a>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <tbody>
						...
						<tr>
						  <td><?php echo $i++;?></td>
                          <td><?php echo $row->template_key;?></td>                       
                          <td><?php echo $row->template_status;?></td>

                          <td>
              					<a onclick="window.location.href = '<?php echo base_url().'admin/smstemplates/edit/'.$row->template_id;?>';" class="btn btn-success act-btn" title="<?php if(!empty($this->phrases["edit"])) echo $this->phrases["edit"]; else echo "Edit";?>"><i class="fa fa-edit"></i> </a>

              					<a data-toggle="modal" data-target="#delRecModal"  onclick="deleteMessage(<?php echo $row->template_id;?>)" class="btn btn-danger act-btn" title="<?php if(!empty($this->phrases["delete"])) echo $this->phrases["delete"]; else echo "Delete";?>"><i class="fa fa-trash"></i> </a>
              						</td>
                        </tr>
...
/****** Delete Message ******/
   function deleteMessage(x){
	...
	var str = "<?php echo base_url();?>admin/smstemplates/delete/"+x;
