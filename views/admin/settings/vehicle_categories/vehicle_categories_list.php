  ...
  <div class="inner-elements">
		...
		<a onclick="window.location.href = '<?php echo base_url().'settings/vehicleCategories/add';?>';" class="btn btn-success" title="Add New"><?php if(isset($this->phrases["add new"])) echo $this->phrases["add new"]; else echo "Add New";?> <i class="fa fa-plus"></i></a>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <tbody>
						...
						<tr>
						  <td><?php echo $i++;?></td>
                          <td><?php echo (isset($this->phrases[$row->category])) ? $this->phrases[$row->category] : $row->category;?></td>
                          <td><?php echo (isset($this->phrases[$row->status])) ? $this->phrases[$row->status] : $row->status;?></td>

                          <td>
							<a onclick="window.location.href = '<?php echo base_url().'settings/vehicleCategories/edit/'.$row->id;?>';" class="btn btn-success act-btn" title="<?php if(isset($this->phrases["edit"])) echo $this->phrases["edit"]; else echo "Edit";?>"><i class="fa fa-edit"></i> </a>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <?php if(isset($this->phrases["all vehicles under this category will be deleted. are you sure to delete the record"])) echo $this->phrases["all vehicles under this category will be deleted. are you sure to delete the record"]; else echo "All Vehicles under this Category will be deleted. Are you sure to delete the Record";?>?
         </div>
...
/****** Delete Message ******/
   function deleteMessage(x){
	...
	var str = "<?php echo base_url();?>settings/vehicleCategories/delete/"+x;
