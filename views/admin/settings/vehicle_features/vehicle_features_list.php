  ...
  <div class="inner-elements">
		...
		<a onclick="window.location.href = '<?php echo base_url().'settings/vehicleFeatures/add';?>';" class="btn btn-success" title="Add New"><?php if(isset($this->phrases["add new"])) echo $this->phrases["add new"]; else echo "Add New";?> <i class="fa fa-plus"></i></a>
		...
		<table id="example" class="cell-border example" cellspacing="0" width="100%">
                   <thead>
                     <tr>
                          <th>#</th>
                          <th><?php if(isset($this->phrases["feature"])) echo $this->phrases["feature"]; else echo "Feature";?></th>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <tbody>
						...
						<tr>
						  <td><?php echo $i++;?></td>
                          <td><?php echo (isset($this->phrases[$row->features])) ? $this->phrases[$row->features] : $row->features;?></td>
                          <td><?php echo (isset($this->phrases[$row->status])) ? $this->phrases[$row->status] : $row->status;?></td>

                          <td>
							<a onclick="window.location.href = '<?php echo base_url().'settings/vehicleFeatures/edit/'.$row->id;?>';" class="btn btn-success act-btn" title="<?php if(isset($this->phrases["edit"])) echo $this->phrases["edit"]; else echo "Edit";?>"><i class="fa fa-edit"></i> </a>
...
/****** Delete Message ******/
   function deleteMessage(x){
	...
	var str = "<?php echo base_url();?>settings/vehicleFeatures/delete/"+x;
