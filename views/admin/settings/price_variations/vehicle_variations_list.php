  ...
  <div class="inner-elements">
		...
		<a onclick="window.location.href = '<?php echo base_url().'settings/price_variations/add';?>';" class="btn btn-success" title="Add New"><?php if(isset($this->phrases["add new"])) echo $this->phrases["add new"]; else echo "Add New";?> <i class="fa fa-plus"></i></a>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <tbody>
						...
						<tr>
						  <td><?php echo $i++;?></td>
                          <td><?php echo (isset($this->phrases[$row->variation_title])) ? $this->phrases[$row->variation_title] : $row->variation_title;?></td>
                          <td><?php echo (isset($this->phrases[$row->variation_status])) ? $this->phrases[$row->variation_status] : $row->variation_status;?></td>

                          <td>
							<a onclick="window.location.href = '<?php echo base_url().'settings/price_variations/edit/'.$row->variation_id;?>';" class="btn btn-success act-btn" title="<?php if(isset($this->phrases["edit"])) echo $this->phrases["edit"]; else echo "Edit";?>"><i class="fa fa-edit"></i> </a>

							<a data-toggle="modal" data-target="#delRecModal"  onclick="deleteMessage(<?php echo $row->variation_id;?>)" class="btn btn-danger act-btn" title="<?php if(isset($this->phrases["delete"])) echo $this->phrases["delete"]; else echo "Delete";?>"><i class="fa fa-trash"></i> </a>
							</td>
                        </tr>
...
/****** Delete Message ******/
   function deleteMessage(x){
	...
	var str = "<?php echo base_url();?>settings/price_variations/delete/"+x;
