  ...
  <div class="inner-elements">
		...
		<a onclick="window.location.href = '<?php echo base_url().'auth/create_user';?>';" class="btn btn-success" title="<?php if(isset($this->phrases["add new"])) echo $this->phrases["add new"]; else echo "Add New";?>"><?php if(isset($this->phrases["add user"])) echo $this->phrases["add user"]; else echo "Add User";?> <i class="fa fa-plus"></i></a>
                    ...
                    <tr>
                      ...
                      <tbody>
						...
						<tr>
                          ...
                          <td>
							<a onclick="window.location.href = '<?php echo base_url().'auth/edit_user/'.$row->id;?>';" class="btn btn-success act-btn" title="<?php if(isset($this->phrases["edit"])) echo $this->phrases["edit"]; else echo "Edit";?>"><i class="fa fa-edit"></i> </a>
...
<script>
   ...
   function deleteMessage(x){
	...
	var str = "<?php echo base_url();?>auth/users/delete/"+x;
   ...
   function changeStatusMessage(x,y){
	...
	var str = "<?php echo base_url();?>auth/users/"+x+"/"+y;
