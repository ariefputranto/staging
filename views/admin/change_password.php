    ...
    <div class="body-content">
      <div class="admin-body">
		  <div class="inner-elements">
			...
			<a onclick="window.location.href='<?php echo base_url();?>admin';" class="btn btn-info" title="Cancel"> <?php if(isset($this->phrases["cancel"])) echo $this->phrases["cancel"]; else echo "Cancel";?></a>
			</div>
			 </form>
