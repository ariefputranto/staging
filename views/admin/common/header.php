...
<section class="top_wrapper">
  ...
  <div class="header admin-header">
    <div class="navbar-brand lg">
        <div class="logo"> <a href="<?php echo base_url();?>admin"><img src="<?php echo base_url().$site_theme.'/';?>assets/system_design/images/<?php if($site_settings->site_logo != "" && file_exists($site_theme.'/'.'assets/system_design/images/'.$site_settings->site_logo)) echo $site_settings->site_logo; else echo "logo.png";?>"></a> </div>
        <!--./logo--></div>
   <div class="col-lg-4 col-md-6 col-sm-7 col-xs-12 pull-right">
   ...
   <ul class="navbar-right login user_proile">
        <li><a href="#"><img height="38" src="<?php echo base_url();?>uploads/admin_profile_pic/<?php if($this->session->userdata('photo') != "" && file_exists('uploads/admin_profile_pic/'.$this->session->userdata('photo'))) echo $this->session->userdata('photo'); else echo "noimage.jpg";?>"> <?php echo $this->session->userdata('username')?></a>
          <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
            <li><a tabindex="-1" href="<?php echo base_url();?>admin/profile"> <i class="fa fa-user"></i> <?php if(isset($this->phrases["my profile"])) echo $this->phrases["my profile"]; else echo "My Profile";?></a></li>
