		  ...
		  <div class="inner-elements">
			...
			<?php echo $this->session->flashdata('message');?>
				<?php 
				  ...
				  echo form_open_multipart('admin/testimonials/'.$param,$attributes);?> 
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					<label><?php if(isset($this->phrases["designation"])) echo $this->phrases["designation"]; else echo "Designation";?>&nbsp;<font color="red">*</font></label>
					 <input type="text" name="designation" id="designation" placeholder="<?php if(isset($this->phrases["designation"])) echo $this->phrases["designation"]; else echo "Designation";?>" value="<?php echo set_value('designation', (isset($record->designation)) ? $record->designation : '');?>"/>
				...
				<input type="hidden" name="is_image_set" id="is_image_set" value="">
					<div class="preview-area">
						...
						<?php if(isset($record->image) && $record->image != "" && file_exists('uploads/testimonials/'.$record->image)) { ?>
							<img height="100" src="<?php echo base_url();?>uploads/testimonials/<?php echo $record->image;?>" >
						<?php } ?>
