  <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12 padding-lr">
    <div class="body-content">
      <div class="admin-body">
		...
		<a onclick="window.location.href = '<?php echo base_url().'admin/testimonials/add';?>';" class="btn btn-success" title="Add New"><?php if(isset($this->phrases["add new"])) echo $this->phrases["add new"]; else echo "Add New";?> <i class="fa fa-plus"></i></a>
		...
		<table id="example" class="cell-border example" cellspacing="0" width="100%">
                   <thead>
                     <tr>
                          ...
                          <th><?php if(isset($this->phrases["designation"])) echo $this->phrases["designation"]; else echo "Designation";?></th>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <tbody>
						...
						<tr>
						  <td><?php echo $i++;?></td>
						  <td><img src="<?php echo base_url();?>uploads/testimonials/<?php if($row->image != "" && file_exists('uploads/testimonials/'.$row->image)) echo $row->image; else echo "default-car.jpg";?>" width="60"></td>
                          ...
                          <td>
							<a onclick="window.location.href = '<?php echo base_url().'admin/testimonials/edit/'.$row->id;?>';" class="btn btn-success act-btn" title="<?php if(isset($this->phrases["edit"])) echo $this->phrases["edit"]; else echo "Edit";?>"><i class="fa fa-edit"></i> </a>
...
/****** Delete Message ******/
   function deleteMessage(x){
	...
	var str = "<?php echo base_url();?>admin/testimonials/delete/"+x;
