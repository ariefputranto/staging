        ...
        <div class="hedder"> 
         ...
         <div class="content">
          ...
          <h3><?php echo $welcme_txt." ".$this->config->item('site_settings')->site_title;?></h3>
            ...
            <p><?php echo (isset($this->phrases["your booking has been"])) ? $this->phrases["your booking has been"] : "Your Booking has been"; ?> <strong><?php if(isset($booking_status)) echo (isset($this->phrases[$booking_status])) ? $this->phrases[$booking_status] : $booking_status;?></strong></p>
            <p><?php echo (isset($this->phrases["and booking reference is"])) ? $this->phrases["and booking reference is"] : "And Booking Reference is"; ?> <strong><?php if(isset($booking_ref)) echo $booking_ref;?></strong></p>
            <p><?php echo (isset($this->phrases["journey cost"])) ? $this->phrases["journey cost"] : "Journey Cost"; ?> <strong><?php if(isset($cost_of_journey)) echo $this->config->item('site_settings')->currency_symbol.$cost_of_journey;?></strong></p>
            <p></p>
         </div>
         <div class="spacer"></div>
      </div>
