    ...
    <div class="col-lg-9">
	  ...
	  <table width="200" border="1" class="ps-de">
          <tbody>
			...
			$required_seats = $details[$journey_type]['adult']+$details[$journey_type]['child']+$details[$journey_type]['infant'];
			$i = 0;
			$shuttles = array();
            ...
            <td>
				...
				<?php }} ?>
				<input type="hidden" name="passenger_seat[]" value="<?php echo $seat;?>">
				<input type="hidden" name="passenger_seat_no[]" value="<?php echo $seat_no;?>">
