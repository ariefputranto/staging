			...
			/* Change Password form validation rules */
              $("#change_password_form").validate({
				...
				messages: {
					...
					new_confirm: {
							  required: "<?php if(isset($this->phrases["please confirm your new password again"])) echo $this->phrases["please confirm your new password again"]; else echo "Please confirm your new password again";?>."
						  }
				},
